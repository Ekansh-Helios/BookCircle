...
const BookAddition = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formData = {
      ...
      book_condition: bookData.book_condition,
      cover: bookData.coverUrl, // Send image URL directly
      clubId: clubId,
    };
    ...
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="text" name="coverUrl" value={bookData.coverUrl} onChange={handleChange} required className="form-control" placeholder="Enter image URL" />
        </div>
        <button type="submit" className="btn btn-primary">Add Book</button>
      </form>
    </div>
